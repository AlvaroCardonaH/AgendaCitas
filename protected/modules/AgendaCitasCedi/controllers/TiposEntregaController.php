...
class TiposEntregaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TiposEntrega']))
		{
			$model->attributes=$_POST['TiposEntrega'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->IdTipoEntrega));
		}
	 ...
	 * @return TiposEntrega the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TiposEntrega::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TiposEntrega $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipos-entrega-form')
		{
