...
class MuellesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation($model);
                $model->MinimoPiezas = 0;
                $model->MaximoPiezas = 0;
		...
		if(isset($_POST['Muelles']))
		{
			$model->attributes=$_POST['Muelles'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->IdMuelle));
		}
	 ...
	 * @param Muelles $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='muelles-form')
		{
