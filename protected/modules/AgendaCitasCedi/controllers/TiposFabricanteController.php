...
class TiposFabricanteController extends Controller
{
	/**
	 ...
	 * @return TiposFabricante the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TiposFabricante::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TiposFabricante $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipos-fabricante-form')
		{
