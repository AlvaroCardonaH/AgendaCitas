...
class EstadosRegistroController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['EstadosRegistro']))
		{
			$model->attributes=$_POST['EstadosRegistro'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->IdEstadoRegistro));
		}
	 ...
	 * @param EstadosRegistro $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='estados-registro-form')
		{
