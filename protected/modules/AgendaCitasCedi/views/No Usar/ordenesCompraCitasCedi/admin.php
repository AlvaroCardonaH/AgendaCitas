...
$this->menu=array(
	...
	array('label'=>'Create OrdenesCompraCitasCedi', 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$('#ordenes-compra-citas-cedi-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Ordenes Compra Citas Cedis</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'ordenes-compra-citas-cedi-grid',
